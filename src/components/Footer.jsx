        ...
        <footer className="bg-background-light dark:bg-background-dark py-10 px-6 border-t border-black/5 dark:border-white/5 mt-auto">
            <div className="flex flex-col gap-6 text-center">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-text-main/60 dark:text-white/60 text-sm">Sábado: 9am a 2pm</p>
                </div>
                <div className="flex justify-center gap-6 mt-2">
                    <a className="text-text-main/40 dark:text-white/40 hover:text-primary transition-colors" href="#">
                ...
                <p className="text-text-main/30 dark:text-white/30 text-xs">© 2025 Habito Café. All rights reserved.</p>
            </div>
        </footer>
    );
}
